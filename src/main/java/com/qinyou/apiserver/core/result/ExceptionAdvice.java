...
public class ExceptionAdvice {
    ...
    public ResponseResult requestExceptionHandler(RequestException e) {
        ...
        return ResponseResult.builder().status(false).code(e.getCode()).msg(e.getMsg()).build();
    }
    ...
    public ResponseResult methodArgumentNotValidExceptionHandler(MethodArgumentNotValidException e) {
        ...
        return ResponseResult.builder().status(false).code(ResponseEnum.BAD_PARAM.code).msg(s).build();
    }
